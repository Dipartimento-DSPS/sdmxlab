...
class SdmxConnector(object):
    ...
    def save_filtered_data(self):
        self.filtered_data.to_sql(json.dumps([self.dataset_id, self.key]), engine)
...
class terminal_controller(object):
    def __init__(self):
        pass

class flask_controller(object):
    def __init__(self):
        pass
...
if __name__ == "__main__":
    ...
    sdmxlab = SdmxConnector("ESTAT",'lfsa_egan22d')
